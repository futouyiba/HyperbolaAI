...
class Game(Bindable):
    def __init__(self, decks, agents):
        ...
        self.players = [Player(agents[play_order[0]][1], decks[play_order[0]], agents[play_order[0]][0], self),
                        Player(agents[play_order[1]][1], decks[play_order[1]], agents[play_order[1]][0], self)]
        self.playersInOrder = [self.players[play_order[0]], self.players[play_order[1]]]
